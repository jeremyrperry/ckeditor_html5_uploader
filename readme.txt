...
-Example with no name or id element:  <textarea class="ckeditor"></textarea>
-Example with name and id element:  <textarea class="ckeditor" name="cke1" id="cke1" ></textarea>
--Either way works.--
...
-No-class Example:  <form action="" method="post">
-Class example:  <form action="" method="post" class="has_cke">
